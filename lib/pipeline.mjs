...
import { deepQc, probeMedia, technicalQc } from "./media.mjs";
import { headObject, presignObject, putJson, storageConfig, streamCopy } from "./s3.mjs";
  ...
  for (const stage of [1, 2, 3]) {
    ...
    try {
      ...
      result[name] = {
        configured: true,
        reachable: false,
        error: String(error?.message || "storage_check_failed").slice(0, 180)
      };
    }
  }
  return result;
